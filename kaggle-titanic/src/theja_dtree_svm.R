#This scirpt reads training and test data from ../data/ folder and constructs a Machine leanring model for prediction.
...
readData  <- read.csv("../data/train.csv")
...
readData <- read.csv("../data/test.csv")
maxFare <- max(readData$fare)
theBreaks <- c(0,7,10,20,30,40,50,75,100,maxFare)
cutFare <- cut(readData$fare,breaks=theBreaks,include.lowest=T)
theBreaks <- c(0,10,20,30,40,50,60,100)
